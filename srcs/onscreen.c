...
/*   Updated: 2016/12/01 18:37:04 by alao             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				wolf_value(t_wolf *w, int off_x, int off_y, int value)
{
	...
	while (*tmp)
	{
		(*tmp - 48 == 0) ? img = IMG_GUI_N0 : (0);
		(*tmp - 48 == 1) ? img = IMG_GUI_N1 : (0);
		(*tmp - 48 == 2) ? img = IMG_GUI_N2 : (0);
		(*tmp - 48 == 3) ? img = IMG_GUI_N3 : (0);
		(*tmp - 48 == 4) ? img = IMG_GUI_N4 : (0);
		(*tmp - 48 == 5) ? img = IMG_GUI_N5 : (0);
		(*tmp - 48 == 6) ? img = IMG_GUI_N6 : (0);
		(*tmp - 48 == 7) ? img = IMG_GUI_N7 : (0);
		(*tmp - 48 == 8) ? img = IMG_GUI_N8 : (0);
		(*tmp - 48 == 9) ? img = IMG_GUI_N9 : (0);
